const vm = new Vue({
    ...
    methods: {
        ...
        viewCastle(id) {
            this.index = this.getIndexById(id)
            this.form.viewLink = this.castles[this.index].link
        ...
        orderByName() {
            this.boolId = false
            let arrowName = document.getElementById("arrowName")
            if (this.boolName) {
                this.castles.sort(this.compareName)
                this.boolName = false
                let strHtml = `NAME <i class="fas fa-chevron-down fa-xs">`
                arrowName.innerHTML = strHtml
                arrowId.innerHTML = `ID`
            }
            else {
                this.castles.sort(this.compareName)
                this.boolName = true
                let strHtml = `NAME <i class="fas fa-chevron-up fa-xs">`
                arrowName.innerHTML = strHtml
                arrowId.innerHTML = `ID`
            }
        ...
        orderById() {
            ...
            if (this.boolId) {
                this.castles.sort(this.compareId)
                this.boolId = false
                let strHtml = `ID <i class="fas fa-chevron-down fa-xs">`
                arrowId.innerHTML = strHtml
                arrowName.innerHTML = `NAME`
            }
            else {
                this.castles.sort(this.compareId)
                this.boolId = true
                let strHtml = `ID <i class="fas fa-chevron-up fa-xs">`
                arrowId.innerHTML = strHtml
                arrowName.innerHTML = `NAME`
            }   
        },
